...
import { ActionIcon, Affix, Button, Container, Group, Navbar, Text, UnstyledButton } from "@mantine/core"
...
const AppList = () => {
  ...
  return (<Group direction="column">
    {appNameList.map((appName) => (
      <UnstyledButton key={appName} onClick={() => { navigate(appName) }} p={4} m={4}>
        <Navbar.Section>
          <Text>{appName}</Text>
        </Navbar.Section>
      </UnstyledButton>
